...
client.on(Events.MessageCreate, async message => {
    ...
    webhooks.forEach(async webhook => {
        ...
        const prompt = `
        In this conversation you should act as ${webhook.name}. This should be a natural conversation, so please reply as briefly and concisely as possible, maximum 200 characters. Respond with only the content part, not the author, and do not repeat previous replies unless specifically asked. You may choose not to reply if the context does not concern you. In that case, output N/A as your message. Here is the last part of the conversation. : ${JSON.stringify(context)}`
